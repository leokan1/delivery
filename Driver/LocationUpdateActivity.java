...
import com.example.karchunkan.fyp.API.Driver.UpdateLocation;
        ...
        GoogleMap.OnMarkerDragListener
{
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(LocationUpdateActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();

        Object dataTransfer[] = new Object[3];
        UpdateLocation updateLocation = new UpdateLocation();
        String url="http://"+ IpAddress.IP_ADDRESS.getIp()+ ApiAddress.UpdateLocation.getAddress()+
                "?driverID="+ MainActivity.userID+
                "&gpsX="+latitude+
                "&gpsY="+longitude;
        Log.d("url", url);

        dataTransfer[0] = url;
        updateLocation.execute(dataTransfer);
