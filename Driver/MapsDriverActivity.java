...
//        end_latitude=getIntent().getDoubleExtra("lastDeliveryX",0);
//        end_longitude=getIntent().getDoubleExtra("lastDeliveryY",0);

        LatLng ll= getIntent().getParcelableExtra("driverGps");
        latitude=ll.latitude;
        longitude=ll.longitude;
        ll=getIntent().getParcelableExtra("lastDelivery");
...
//                String url = getDirectionsUrl(start_Lat,start_lon,end_Lat,end_lon,waypoint);
        String url="https://maps.googleapis.com/maps/api/directions/json?"+
                ...
                "&destination="+end_latitude+","+longitude+
